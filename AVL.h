...
namespace cop3530{
    ...
    private:
        ...
        NodePtr do_insert(NodePtr root, const K& key, const V& value){
            ...
            if(balance >= 2){
                int lrh = (root->left->right) ? do_height(root->left->right) : 0;
                int llh = (root->left->left) ? do_height(root->left->left) : 0;
                if(lrh > llh){
                ...
                int rlh = (root->right->left) ? do_height(root->right->left) : 0;
                int rrh = (root->right->right) ? do_height(root->right->right) : 0;
                if(rlh > rrh){
        ...
        NodePtr do_remove(NodePtr root, const K& key) {
            ...
            if (root == nullptr) {
                throw runtime_error("Error! User tried to remove key that does not exist in AVL TreeMap!!!");
            }
        ...
        V& do_lookup(NodePtr root, const K& key)const{
            if(root == nullptr){
                throw runtime_error("Error! User tried to search for key that does not exist in AVL TreeMap!!!");
            }
            if(equality(root->key,key)){
                return root->value;
            }
    ...
    public:
        AVL(){
            cout << "Creating AVL-Based TreeMap!!!" << endl;
        }

        ~AVL() {
            cout << "Destroying AVL-Based TreeMap!!!" << endl;
        ...
        AVL(const AVL& src){
            ...
            cout << "Creating AVL-Based TreeMap(COPY CTR)!!!" << endl;
        ...
        AVL& operator=(const AVL& src){
            ...
            cout << "Inside copy-assignment operator overloaded function for AVL-Based TreeMap!!!" << endl;
        ...
        AVL& operator=(AVL&& src) {

            cout << "Inside move-assignment operator overloaded function for AVL-Based TreeMap!!!" << endl;
        ...
        AVL(AVL&& src) {
            ...
            cout << "Creating AVL-Based TreeMap(MOVE CTR)!!!" << endl;
